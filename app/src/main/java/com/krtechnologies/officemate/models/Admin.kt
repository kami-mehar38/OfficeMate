...
data class Admin(
    ...
    override fun toString(): String {
        return "Admin(id='$id', name='$name', email='$email', profilePicture='$profilePicture', password='$password', organization='$organization', designation='$designation', subscription='$subscription', isAdmin='$isAdmin', joiningDate='$joiningDate')"
    }
}